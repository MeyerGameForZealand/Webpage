...
function generate_table() {
    ...
    var tblBody = document.getElementById("PlayerTable");
    tblBody.innerHTML = "";
    // creating all cells
    for (var i = 1; i < 7; i++) {
        // creates a table row
        ...
        var cellTextName = document.createElement("input");
        var cellTextLiv = document.createTextNode("" + i);
...
function generate_Leadertable() {
    ...
    // get the reference for the cells
    var tblBody = document.getElementById("LeaderTable");
    tblBody.innerHTML = "";
    // creating all cells
    for (var i = 1; i < 7; i++) {
        // creates a table row
        ...
        var cellText = document.createTextNode("Place" + i);
        var cellText2 = document.createTextNode("Player" + i);
        var cellText3 = document.createTextNode("Antal Spil " + i);
        var cellText4 = document.createTextNode("Win " + i + " / Loss " + i);
        cell.appendChild(cellText);
        cell2.appendChild(cellText2);
        cell3.appendChild(cellText3);
